...
//  PasscodeLock
//
//  Created by Huang ChienShuo on 12/24/12.
//  Copyright (c) 2012 ThousandSquare. All rights reserved.
//
...
@synthesize passcodeLockWindow = _passcodeLockWindow;


- (void) dealloc
{
    [_window release];
    [_passcodeLockWindow release];
    [super dealloc];
}
...
- (BOOL) application:(UIApplication*) application didFinishLaunchingWithOptions:(NSDictionary*) launchOptions
{
    ...
    self.passcodeLockWindow = [[[PasscodeLockWindow alloc] initPasscodeLockWindow] autorelease];
